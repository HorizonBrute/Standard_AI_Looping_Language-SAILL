...
meanings, is cataloged in `./agent_team_flags.md`; add your own in
`agent_team_flags.local.md` (gitignored) or by hand-editing the file directly. List them any time with
